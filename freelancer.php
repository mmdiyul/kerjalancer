        ...
        <div class="container-fluid h-100 d-flex flex-column justify-content-center align-items-center text-center text-white">
            ...
            <div class="mb-3">
                <a href="./cari-kerja.php">
                    <button class="btn btn-outline-light btn-lg">Cari Pekerjaan</button>
                </a>
                &nbsp;&nbsp;&nbsp;Atau&nbsp;&nbsp;&nbsp;
                <a href="./portfolio-saya.php">
                    <button class="btn btn-outline-light btn-lg">Portfolio</button>
                </a>
            </div>
        </div>
    </section>
